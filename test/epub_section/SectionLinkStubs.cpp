...
// same "a truncated read yields null" and "the nothrow allocation may fail"
// contracts -- so PageImage::deserialize can be exercised over real cache bytes.
// The rest of the image pipeline stays stubbed. gImageBlockDeserializeFails stands
// in for that allocation failing under memory pressure.
